...
const Workers: React.FC = () => {
  ...
  const workerSteps: VisionStep[] = [
    {
      icon: IMAGES.profile,
      title: t('workers.steps.0.title'),
      description: t('workers.steps.0.description'),
      keywords: t('workers.steps.0.keywords', { returnObjects: true }) as string[]
    },
    {
      icon: IMAGES.skills,
      title: t('workers.steps.1.title'),
      description: t('workers.steps.1.description'),
      keywords: t('workers.steps.1.keywords', { returnObjects: true }) as string[]
    },
    {
      icon: IMAGES.portfolio,
      title: t('workers.steps.2.title'),
      description: t('workers.steps.2.description'),
      keywords: t('workers.steps.2.keywords', { returnObjects: true }) as string[]
    },
    {
      icon: IMAGES.matching,
      title: t('workers.steps.3.title'),
      description: t('workers.steps.3.description'),
      keywords: t('workers.steps.3.keywords', { returnObjects: true }) as string[]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 to-blue-900 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className={`text-center mb-8 transition-all duration-1000 ${isHeaderVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-12'}`}>
          <h1 className="text-4xl md:text-5xl font-bold mb-3">{t('workers.title')}</h1>
          <p className="text-xl text-blue-200 max-w-3xl mx-auto">{t('workers.subtitle')}</p>
        </div>
