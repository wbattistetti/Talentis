      ...
      <DialogContent>
        <Box sx={{ py: 2 }}>
          <Typography paragraph>
            Ottimo! Ora che abbiamo acquisito le foto dei tuoi documenti, procederemo con una breve verifica biometrica che include:
          </Typography>
          ...
          <Typography paragraph sx={{ mt: 2 }}>
            Questi dati verranno utilizzati esclusivamente per verificare la corrispondenza con i documenti appena forniti e garantire la sicurezza del processo.
          </Typography>
        </Box>
      </DialogContent>
